...
export type SSEStreamEvent =
    | { readonly type: 'token_delta'; readonly text: string; readonly tokenCount: number }
    | { readonly type: 'tool_call_start'; readonly toolName: string; readonly input: Record<string, unknown> }
    | { readonly type: 'vector_search_result'; readonly chunks: ReadonlyArray<{ readonly id: string; readonly score: number; readonly text: string }> }
    | { readonly type: 'finish'; readonly reason: 'stop' | 'length' | 'tool_calls'; readonly totalTokens: number }
